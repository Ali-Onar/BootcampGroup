...
if (isset($_GET['blog'])) {
    ...
    if (isset($_SESSION['data'])) {
        $_SESSION['data'][(int)$_GET['blog']]['seen'] = true;
    } else {
        $data[(int)$_GET['blog']]['seen'] = true;
        $_SESSION['data'] = $data;
    }
}
?>
    ...
    <div class="col-md-offset-1 col-md-10 col-md-offset-1" style="margin-top: 25px;">
        <div>
            <div style="display: flex;">
                <h3 style="    width: 100%;">Lorem Ipsum</h3>
                <div class="pull-right" style="    text-align: right;
                                                    ...
                                                    height: 40px;
                                                    margin-top: 20px;">
                    <a class="btn btn-info" href="seen-delete.php?blog=<?php echo (int)$_GET['blog']; ?>" style="color: purple; background-color: white;">Okunanlardan Kaldır</a>
                </div>
            </div>
        </div>
